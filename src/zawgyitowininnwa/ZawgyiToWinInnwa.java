...
public class ZawgyiToWinInnwa extends JFrame
{
    public void zawgyiToWinInnwa (String words)
    {
        ...
        try
        {
            ...
            int checkSave = saveFile.showSaveDialog(ZawgyiToWinInnwa.this);
            ...
            if (checkSave == JFileChooser.APPROVE_OPTION)
            {
                ...
                for (int i = 0; i < words.length (); i++)
                {
                    ...
                    paragrahRun.setText(WordToChar(originalChar));
    ...
    public String WordToChar (char originalChar)
    {
        char singChar, tmp = '\0', tmp2 = '\0', tmp3 = '\0', tmp4 = '\0', tmp5 = '\0';  
        ...
        if (tmp != '\0' && tmp2 != '\0' && tmp3 != '\0' && tmp4 != '\0' && tmp5 != '\0')
            multipleChars = Character.toString(singChar) + Character.toString(tmp) + Character.toString(tmp2)
                            + Character.toString(tmp3) + Character.toString(tmp4) + Character.toString(tmp5);
        else if (tmp != '\0' && tmp2 != '\0' && tmp3 != '\0' && tmp4 != '\0')
             multipleChars = Character.toString(singChar) + Character.toString(tmp) + Character.toString(tmp2)
                            + Character.toString(tmp3) + Character.toString(tmp4);
        else if (tmp != '\0' && tmp2 != '\0' && tmp3 != '\0')
             multipleChars = Character.toString(singChar) + Character.toString(tmp) + Character.toString(tmp2)
                            + Character.toString(tmp3);
        else if (tmp != '\0' && tmp2 != '\0' )
             multipleChars = Character.toString(singChar) + Character.toString(tmp) + Character.toString(tmp2);
        else if (tmp != '\0')
             multipleChars = Character.toString(singChar) + Character.toString(tmp);
        else 
            multipleChars = Character.toString(singChar);
